...
const NavbarHeader = () => {
    return (
        <div className='w-100'>
            <header className="header_wrap fixed-top light_skin sticky_dark_skin main_menu_uppercase transparent_header dd_dark_skin">
                            ...
                            <ul className="navbar-nav">
                                <li className="dropdown">
                                    ...
                                    <div className="dropdown-menu">
                                        <ul>
                                            <li><a className="dropdown-item nav-link nav_item active" href="index.html">Homepage
                                                1</a></li>
                                            <li><a className="dropdown-item nav-link nav_item" href="index-2.html">Homepage
                                                2</a>
                                            </li>
                                            <li><a className="dropdown-item nav-link nav_item" href="index-3.html">Homepage
                                                3</a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="dropdown-menu">
                                        <ul>
                                            <li className="dropdown">
                                                ...
                                                <div className="dropdown-menu">
                                                    <ul>
                                                        <li><a className="dropdown-item nav-link nav_item" href="about.html">About
                                                            Us</a></li>
                                                        <li><a className="dropdown-item nav-link nav_item" href="about-2.html">About
                                                            Us 2</a></li>
                                                    </ul>
                                                </div>
                                            </li>
                                            ...
                                            <li><a className="dropdown-item nav-link nav_item" href="book-table.html">Book
                                                Table</a>
                                            </li>
                                            <li><a className="dropdown-item nav-link nav_item" href="login.html">Login</a></li>
                                            <li><a className="dropdown-item nav-link nav_item" href="register.html">Register</a>
                                            </li>
                                            <li><a className="dropdown-item nav-link nav_item" href="404.html">404 Error
                                                Page</a>
                                            </li>
                                            <li><a className="dropdown-item nav-link nav_item" href="coming-soon.html">Coming
                                                Soon</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li className="dropdown"><a className="dropdown-toggle nav-link" data-toggle="dropdown" href="#">Menu</a>
                                    <div className="dropdown-menu">
                                        <ul>
                                            ...
                                            <li><a className="dropdown-item nav-link nav_item" href="menu-2.html">Menu Style
                                                2</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li className="dropdown"><a className="dropdown-toggle nav-link" data-toggle="dropdown" href="#">Chef</a>
                                    <div className="dropdown-menu">
                                        <ul>
                                            ...
                                            <li><a className="dropdown-item nav-link nav_item" href="chef-detail.html">Chef
                                                Detail</a></li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li className="dropdown"><a className="dropdown-toggle nav-link" data-toggle="dropdown" href="#">Shop</a>
                                    <div className="dropdown-menu dropdown-menu-right">
                                        <ul>
                                            <li><a className="dropdown-item nav-link nav_item" href="shop-product-detail.html">Shop
                                                Product Detail</a></li>
                                            <li><a className="dropdown-item nav-link nav_item" href="shop-cart.html">Shop
                                                Cart</a>
                                            </li>
                        ...
                        <ul className="navbar-nav attr-nav align-items-center">
                            <li><a href="javascript:void(0);" className="nav-link search_trigger"><i className="linearicons-magnifier" /></a>
                                <div className="search_wrap">
                                    <span className="close-search"><i className="ion-ios-close-empty" /></span>
                                    <form>
                            ...
                            <li><a className="nav-link cart_trigger" href="javascript:void(0);"><i className="linearicons-cart" /><span className="cart_count">2</span></a>
                                <div className="cart_box">
                                    ...
                                    <ul className="cart_list">
                                        <li>
                                            ...
                                            <a href="#"><img src="assets/images/cart_thamb1.jpg" alt="cart_thumb1" />Berry
                                                Salad</a>
                                            <span className="cart_quantity"> 1 x <span className="cart_amount"> <span className="price_symbole">$</span></span>78.00</span>
                                        </li>
                                        <li>
                                            <a href="#" className="item_remove"><i className="ion-close" /></a>
                                            <a href="#"><img src="assets/images/cart_thamb2.jpg" alt="cart_thumb2" />Milky
                                                Fruit</a>
                                            <span className="cart_quantity"> 1 x <span className="cart_amount"> <span className="price_symbole">$</span></span>81.00</span>
                                        </li>
                                        <li>
                                            <a href="#" className="item_remove"><i className="ion-close" /></a>
                                            <a href="#"><img src="assets/images/cart_thamb3.jpg" alt="cart_thumb3" />Egg
                                                Bread</a>
                                            <span className="cart_quantity"> 1 x <span className="cart_amount"> <span className="price_symbole">$</span></span>78.00</span>
                                        </li>
                                        <li>
                                            <a href="#" className="item_remove"><i className="ion-close" /></a>
                                            <a href="#"><img src="assets/images/cart_thamb4.jpg" alt="cart_thumb4" />Orange
                                                Jam</a>
                                            <span className="cart_quantity"> 1 x <span className="cart_amount"> <span className="price_symbole">$</span></span>81.00</span>
                                        </li>
                                    </ul>
